...
Throughout this paper, a citation refers to any named reference to a person detected in a manifesto text. This includes both approving and critical mentions. I use "citation" rather than "mention" to reflect the political discourse literature's understanding that naming a figure in a public speech act, regardless of rhetorical intent, constitutes a discursive choice about the political figures that matter in one's political argument.
...
\begin{table}[h]                                                         
    \centering                                                           \begin{tabular}{lr}                                                    \hline                                                               \textbf{Metric} & \textbf{Value} \\                                  \hline                                                               True Positives (TP)  & 132   \\                                      False Positives (FP) & 22    \\                                      False Negatives (FN) & 3     \\                                      \hline                                                               Precision            & 0.857 \\                                      Recall               & 0.978 \\                                      F1 Score             & 0.913 \\                                      \hline                                                               Precision (femme)    & 0.812 \\
